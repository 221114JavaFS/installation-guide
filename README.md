...
- **Java SE Development Kit 11**: We will be utilizing Java 11 as our primary language for the duration of the program. This software development kit will provide the compiler and runtime environment needed to quickly and efficiently develop Java applications. NOTE: While we will only cover topics and features of Java up to Java 8, Java 11 is being installed to better intigrate with some other tools we will be using. Java 11 is backwards compatable with all features of Java 8 we will be discussing. 
...
1. Navigate in your web browser to [Oracle's JDK 11](https://www.oracle.com/java/technologies/downloads/#java11) download page. NOTE: If you are experiencing errors when trying to load the webpage try another browser. If you still are having trouble, try again later. 
...
5. Return to [Oracle's JDK 11](https://www.oracle.com/java/technologies/downloads/#java11) website. Make sure you click the Windows tab to get the Windows installer and click to download. 

![](./images/JDK-Download.jpg)

6. A popup will ask you to review the license before continuing. Do so and click the check box and then the download button. NOTE: Some of the following images will show a Java 8 installation/version but the process will be the same for Java 11.  
